...
public class ConfigConstants {
    ...
    // Metrics Constant
    public static final String MULTIPLE_PRODUCER_TARGET_TOPIC_ERROR_TOTAL = "kafka_multiple_producer_target_topic_error_total";
    public static final String MULTIPLE_PRODUCER_DLT_ERROR_TOTAL = "kafka_multiple_producer_dlt_topic_error_total";
    public static final String SINGLE_PRODUCER_TARGET_TOPIC_ERROR_TOTAL = "kafka_single_producer_target_topic_error_total";
    public static final String SINGLE_PRODUCER_DLT_ERROR_TOTAL = "kafka_single_producer_dlt_topic_error_total";
