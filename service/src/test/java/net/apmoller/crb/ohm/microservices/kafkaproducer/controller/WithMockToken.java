package net.apmoller.crb.ohm.microservices.kafkaproducer.controllers;
...
@WithSecurityContext(factory = net.apmoller.crb.ohm.microservices.kafkaproducer.controllers.WithMockTokenSecurityContextFactory.class)
...
class WithMockTokenSecurityContextFactory implements WithSecurityContextFactory<WithMockToken> {
    ...
    @Override
    public SecurityContext createSecurityContext(net.apmoller.crb.ohm.microservices.kafkaproducer.controllers.WithMockToken tokenAnnotation) {
